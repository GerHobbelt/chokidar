...
function createFsWatchInstance(path, options, oldStats, chokidarInstance, listener, errHandler, emitRaw) {
  var handleEvent = function(rawEvent, evPath) {
    if (
      ...
      // in macOS 10.13 and higher, although it probably did test
      // correctly in lower versions. Do not istanbul ignore in case
      // future macOS versions test this correctly.
