...
function(dir, stats, initialAdd, depth, target, wh, callback) {
  ...
  var read = function(directory_, initialAdd, done) {
    ...
    readdirp({
      ...
      // Files that are absent in current directory snapshot
      // but present in previous emit `remove` event and are
...
function(path, initialAdd, priorWh, depth, target, callback_) {
